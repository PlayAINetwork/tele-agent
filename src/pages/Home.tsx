...
const Home = () => {
  return (
    <div className="relative h-full flex justify-center items-center w-full">
      ...
      <div className=" md:hidden flex justify-end w-[100%]">
          <img
            src={IMAGES.homehero}
            alt=""
            className="w-full h-full object-cove max-w-[200px]"
          />
        </div>
      ...
      <div className=" flex flex-col items-center md:items-start relative border-y-4 py-14 w-full bg-[#01010180] px-4 md:px-20 border-[#89FC96] border-solid [border-image-source:linear-gradient(90deg,#89FC96_0%,rgba(137,252,150,0)_100%)] [border-image-slice:1]">
        <div className="hidden md:block absolute mb-6 md:mb-0 right-0 bottom-0 w-[300px]">
          <img
            src={IMAGES.homehero}
            alt=""
        ...
        <div className="relative">
          <div className="flex  flex-col gap-2 uppercase">
            <p className="text-center md:text-start text-4xl md:text-4xl md:leading-[50px]">
          ...
          <div className="absolute bottom-[-77px] flex justify-center md:justify-start w-full">
            <Button className="!font-semibold  transform transition-transform duration-500 ease-out hover:scale-[1.02] w-[80%] md:w-auto">
