...
const StackBox = () => {
    ...
    return (
        <div className="flex h-full overflow-auto w-full flex-col justify-between">
            ...
            <div className="flex justify-between">
                <div
                    ...
                    className={`px-4 w-full uppercase text-md  py-2 cursor-pointer ${isStake ? "bg-[#E8E8E8] text-[#010101]" : "bg-[#181818] text-[#E8E8E8]"
                        }`}
                >
                    {">> stake_$rogue"}
                </div>
            ...
            <div className="flex flex-col h-full py-6 px-4 w-full  justify-center items-center gap-4 bg-[#131314]">
                 ...
                 */}
                        ...
                        <div className="flex w-full border-[1px] border-[#E8E8E8]">
                            <Input
            ...
            <div className="flex w-full gap-0">
                {wallet.connected ? (
                    <>
                        ...
                        <Button
                            className="uppercase w-full bg-[#E8E8E8]"
