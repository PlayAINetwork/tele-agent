...
import { Program, AnchorProvider, BN, web3, Provider } from "@project-serum/anchor";
...
<div className="flex justify-between">
          <div
            ...
            className={`px-4 w-full uppercase text-md  py-2 cursor-pointer ${
              isStake ? "bg-[#E8E8E8] text-[#010101]" : "bg-[#181818] text-[#E8E8E8]"
            }`}
          >
            {">> stake_$rogue"}
          </div>
